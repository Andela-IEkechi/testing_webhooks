class Project < ActiveRecord::Base
  ...
  attr_accessible :title, :ticket_statuses_attributes, :user_id, :sprint_duration, :api_key, :participant_ids, :participants_attributes, :memberships
  accepts_nested_attributes_for :ticket_statuses, :memberships, :participants
