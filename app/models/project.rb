class Project < ActiveRecord::Base
  ...
  attr_accessible :title, :private, :user_id, :ticket_statuses_attributes, :api_keys_attributes, :memberships_attributes
  ...
  def owner_membership
    self.memberships.build(:user_id => self.user.id, :role => 'admin')
  end
